			...
			var finalInit = __assign(__assign(__assign(__assign({}, _this.props.init), {
				...
				setup: function(editor) {
					...
					if (_this.props.disabled) {
						if (isDisabledOptionSupported(_this.editor)) _this.editor.options.set("disabled", _this.props.disabled);
		...
		if (this.editor) {
			...
			if (this.editor.initialized) {
				...
				if (this.props.disabled !== prevProps.disabled) {
					if (isDisabledOptionSupported(this.editor)) this.editor.options.set("disabled", this.props.disabled);
