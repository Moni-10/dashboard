		...
		*/
		...
		const addSplitButton = (editor, id, tooltip, cmd, nodeName, styles) => {
			...
			editor.ui.registry.addSplitButton(id, {
				...
				select: (value) => {
					return getSelectedStyleType(editor).exists((listStyle) => value === listStyle || listStyleTypeAliases[listStyle] === value && !stylesContainsAliasMap[value]);
				},
		...
		var Plugin = () => {
			global$1.add("advlist", (editor) => {
				if (editor.hasPlugin("lists")) {
					...
					register(editor);
					register$2(editor);
				} else console.error("Please use the Lists plugin together with the List Styles plugin.");
			});
		};
		Plugin();
		/** *****
