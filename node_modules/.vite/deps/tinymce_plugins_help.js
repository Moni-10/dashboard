...
//#endregion
//#region node_modules/tinymce/plugins/help/index.js
(/* @__PURE__ */ __commonJSMin((() => {
	...
	*/
	(function() {
		...
		*/
		const random = () => window.crypto.getRandomValues(/* @__PURE__ */ new Uint32Array(1))[0] / 4294967295;
		/**
		...
		*/
		...
		const tab$1 = (editor) => {
			...
			const pluginLister = (editor) => {
				...
				return "<p><b>" + global$2.translate(["Plugins installed ({0}):", count]) + "</b></p><ul>" + pluginsString + "</ul>";
			};
		...
		const tab = () => {
			...
			const changeLogLink = "<a data-alloy-tabstop=\"true\" tabindex=\"-1\" href=\"https://www.tiny.cloud/docs/tinymce/8/changelog/?utm_campaign=help_dialog_version_tab&utm_source=tiny&utm_medium=referral\" rel=\"noopener\" target=\"_blank\">TinyMCE " + getVersion(global.majorVersion, global.minorVersion) + "</a>";
			return {
				name: "versions",
				title: "Version",
				items: [{
		...
		const parseHelpTabsSetting = (tabsFromSettings, tabs) => {
			...
			return {
				tabs: newTabs,
				names: map(tabsFromSettings, (t) => {
					if (isString(t)) {
						if (has(tabs, t)) newTabs[t] = tabs[t];
						return t;
					} else {
