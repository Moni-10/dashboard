...
//#endregion
//#region node_modules/tinymce/plugins/autolink/index.js
	...
	(function() {
		...
		*/
		...
		const parseCurrentLine = (editor, offset) => {
			...
			if (dom.getParent(selection.getNode(), "a[href]") !== null || editor.mode.isReadOnly()) return null;
			...
			if (matches) {
				let url = matches[0];
				if (startsWith(url, "www.")) url = getDefaultLinkProtocol(editor) + "://" + url;
		...
		const convertToLink = (editor, result) => {
			...
			if (!editor.dispatch("BeforeExecCommand", args).isDefaultPrevented()) {
