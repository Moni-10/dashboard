    ...
    <div id="pre-load">
        <div id="loader" class="loader">
            <div class="loader-container">
                <div class="loader-icon"><img src="assets/img/logo.png" alt=""></div>
            </div>
        </div>
    </div>
    <!-- preloader end -->
                ...
                <div class="rs-header-inner">
                    ...
                    <div class="rs-header-right">
                        ...
                        <div class="header-translate">
                            <a href="https://translate.google.com/translate?sl=auto&amp;tl=en&amp;u=http://127.0.0.1:5501/index.html"
                                target="_blank" rel="noopener noreferrer" aria-label="Translate website">
                                <i class="ri-translate-2"></i><span>Translate</span>
                            </a>
                        </div>
                        <!-- search area end -->
                        <div class="rs-header-btn">
                            <a class="rs-btn has-theme-orange has-icon has-bg" href="contact.php">Get In Touch
                                <span class="icon-box">
                        ...
                        <div class="rs-header-logo-wrapper">
                            <div class="rs-header-logo">
                                <a href="index.php"><img src="assets/img/logo.png"
                                        alt="Mohindra Mechanical Works logo"></a>
                            </div>
                        </div>
                    </div>
                    <div class="rs-header-menu">
                ...
                <div class="offcanvas-content">
                    <div class="offcanvas-top d-flex justify-content-between align-items-center mb-20">
                        <div class="offcanvas-logo">
                            <a class="logo-black" href="index.php"><img src="assets/img/logo.png"
                                    alt="Mohindra Mechanical Works logo"></a>
                        </div>
                    ...
                    <div class="offcanvas-about mb-30 d-none d-sm-block">
                        <p>Mohindra Mechanical Works provides dependable rotogravure printing and industrial
                            machinery solutions.</p>
                    </div>
                    <div class="offcanvas-gallery d-none d-sm-block">
                        <div class="offcanvas-gallery-thumb-wrapper">
                            <div class="offcanvas-popup-thumb">
                                <a class="popup-image" href="assets/img/machines/ELS-Rotogravure-Printing.webp">
                                    <img src="assets/img/machines/ELS-Rotogravure-Printing.webp" alt="Mohindra ELS rotogravure machine">
                                </a>
                            </div>
                            <div class="offcanvas-popup-thumb">
                                <a class="popup-image" href="assets/img/machines/MLS-Rotogravure-Printing-Machine.webp">
                                    <img src="assets/img/machines/MLS-Rotogravure-Printing-Machine.webp" alt="Mohindra MLS rotogravure machine">
                                </a>
                            </div>
                            <div class="offcanvas-popup-thumb">
                                <a class="popup-image" href="assets/img/machines/Rotogravure-Printing-Machine.webp">
                                    <img src="assets/img/machines/Rotogravure-Printing-Machine.webp" alt="Mohindra rotogravure machine">
                                </a>
                            </div>
                            <div class="offcanvas-popup-thumb">
                                <a class="popup-image" href="assets/img/machines/Shafted-Rotogravure-Printing.webp">
                                    <img src="assets/img/machines/Shafted-Rotogravure-Printing.webp" alt="Mohindra shafted rotogravure machine">
                                </a>
                            </div>
                            <div class="offcanvas-popup-thumb">
                                <a class="popup-image" href="assets/img/machines/Saftless-Rotogravure-Printing-Machine.webp">
                                    <img src="assets/img/machines/Saftless-Rotogravure-Printing-Machine.webp" alt="Mohindra shaftless rotogravure machine">
                                </a>
                            </div>
                            <div class="offcanvas-popup-thumb">
                                <a class="popup-image" href="assets/img/machines/Pharmaceutical-Foil-Printing-Machine.webp">
                                    <img src="assets/img/machines/Pharmaceutical-Foil-Printing-Machine.webp" alt="Mohindra pharmaceutical foil machine">
                                </a>
                            </div>
                        </div>
                    </div>
                        ...
                        <ul>
                            <li class="d-flex align-items-center gap-15">
                                ...
                                <div class="offcanvas-contact-text">
                                    <a href="https://www.google.com/maps/search/?api=1&amp;query=RZ-73%2C+Nursing+Garden%2C+near+Khyala+Village%2C+New+Delhi%2C+Delhi+110018"
                                        target="_blank" rel="noopener noreferrer">RZ-73, Nursing Garden, near Khyala<br>
                                        Village, New Delhi, Delhi 110018</a>
                                </div>
                            </li>
                            <li class="d-flex align-items-center gap-15">
                                <div class="offcanvas-contact-icon">
                                ...
                                <div class="offcanvas-contact-text">
                                    <a href="tel:+919988440777">Azadvinder Singh: +91 99884 40777</a>
                                </div>
                            </li>
                            <li class="d-flex align-items-center gap-15">
                                <div class="offcanvas-contact-icon">
                                ...
                                <div class="offcanvas-contact-text">
                                    <a href="mailto:info@mohindraroto.com">info@mohindraroto.com</a>
                                </div>
                            </li>
                        </ul>
                    </div>
                    <div class="offcanvas-social">
                        ...
                        <ul>
                            <li><a href="https://www.instagram.com/mohindramechanical/" target="_blank"
                                    rel="noopener noreferrer" aria-label="Instagram" title="Instagram"><i
                                        class="fab fa-instagram"></i></a></li>
                            <li><a href="https://www.facebook.com/mohindramechanicalworksdelhi/" target="_blank"
                                    rel="noopener noreferrer" aria-label="Facebook" title="Facebook"><i
                                        class="fab fa-facebook-f"></i></a></li>
                            <li><a href="https://www.youtube.com/@mohindramechanicalworks" target="_blank"
                                    rel="noopener noreferrer" aria-label="YouTube" title="YouTube"><i
